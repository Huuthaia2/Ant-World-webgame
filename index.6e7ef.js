System.register(["./application.1f6f9.js"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_application1f6f9Js) {
      createApplication = _application1f6f9Js.createApplication;
    }],
    execute: function () {
...
window.minigame.initializeAsync()
.then(function () {
  console.info("999999minigame success to init");
})
.catch(function (e) {
  console.info("999999initializeAsync error: " + e);
})