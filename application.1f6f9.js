System.register([], function (_export, _context) {
  ...
  function createApplication(_ref) {
    ...
    function loadSettingsJson(cc) {
      var settings = 'src/settings.bdf6d.json';
      return new Promise(function (resolve, reject) {
  ...
  function onGameStarted(cc, settings) {
    ...
    var launchScene = settings.launchScene; // load scene
    cc.director.loadScene(launchScene, function (err, scene) {
      cc.view.setDesignResolutionSize(750, 1334, 4);
      console.log("999999Success to load scene: ".concat(launchScene));
      window.minigame.setLoadingProgress(100);
      window.minigame.startGameAsync()
        .then(function () {
          console.info("999999miniqame success to start");
        })
        .catch(function (e) {
          console.info("999999startGameAsync error: " + e);
        })
    });
  }
